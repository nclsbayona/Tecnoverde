...
type PedirDatosPagarCompra struct {
	focusIndex      int
	title           string
...
func startModelPedirDatosPagarCompra(fields []string, title string, funcion_general func(string, string) (Interfaces.ModeloDeDatos, error)) PedirDatosPagarCompra {
	m := PedirDatosPagarCompra{
...
func (m PedirDatosPagarCompra) Init() tea.Cmd {
	return textinput.Blink
}

func (m PedirDatosPagarCompra) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	switch msg := msg.(type) {
	case tea.KeyMsg:
		switch msg.String() {
		default:
...
func (m *PedirDatosPagarCompra) updateInputs(msg tea.Msg) tea.Cmd {
	cmds := make([]tea.Cmd, len(m.inputs))
...
func (m PedirDatosPagarCompra) View() string {
...
func NewPedirDatosPagarCompra(fields []string, title string, funcion_general func(string, string) (Interfaces.ModeloDeDatos, error)) PedirDatosPagarCompra {
	return startModelPedirDatosPagarCompra(fields, title, funcion_general)
}
