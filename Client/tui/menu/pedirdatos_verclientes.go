...
type PedirDatosVerClientes struct {
	focusIndex      int
	title           string
...
func startModelPedirDatosVerClientes(fields []string, title string, funcion_general func() ([]Interfaces.ModeloDeDatos, error), funcion_especifica func(int) (Interfaces.ModeloDeDatos, error)) PedirDatosVerClientes {
	m := PedirDatosVerClientes{
		inputs:          make([]textinput.Model, len(fields)),
		title:           title,
		funcion_general: funcion_general,
		funcion_unica:   funcion_especifica,
	}
...
func (m PedirDatosVerClientes) Init() tea.Cmd {
	return textinput.Blink
}

func (m PedirDatosVerClientes) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	switch msg := msg.(type) {
	case tea.KeyMsg:
		switch msg.String() {
		default:
...
func (m *PedirDatosVerClientes) updateInputs(msg tea.Msg) tea.Cmd {
	cmds := make([]tea.Cmd, len(m.inputs))
...
func (m PedirDatosVerClientes) View() string {
...
func NewPedirDatosVerClientes(fields []string, title string, funcion_general func() ([]Interfaces.ModeloDeDatos, error), funcion_unica func(int) (Interfaces.ModeloDeDatos, error)) PedirDatosVerClientes {
	return startModelPedirDatosVerClientes(fields, title, funcion_general, funcion_unica)
}
