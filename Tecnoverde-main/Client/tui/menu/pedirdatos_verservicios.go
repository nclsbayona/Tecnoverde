...
type PedirDatosVerServicios struct {
	focusIndex           int
	title                string
...
func startModelPedirDatosVerServicios(fields []string, title string, funcion_general func() ([]Interfaces.ModeloDeDatos, error), funcion_general_tipo func(string) ([]Interfaces.ModeloDeDatos, error), funcion_especifica func(int) (Interfaces.ModeloDeDatos, error)) PedirDatosVerServicios {
	m := PedirDatosVerServicios{
...
func (m PedirDatosVerServicios) Init() tea.Cmd {
	return textinput.Blink
}

func (m PedirDatosVerServicios) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	switch msg := msg.(type) {
	case tea.KeyMsg:
		switch msg.String() {
		default:
...
func (m *PedirDatosVerServicios) updateInputs(msg tea.Msg) tea.Cmd {
	cmds := make([]tea.Cmd, len(m.inputs))
...
func (m PedirDatosVerServicios) View() string {
...
func NewPedirDatosVerServicios(fields []string, title string, funcion_general func() ([]Interfaces.ModeloDeDatos, error), funcion_general_tipo func(string) ([]Interfaces.ModeloDeDatos, error), funcion_unica func(int) (Interfaces.ModeloDeDatos, error)) PedirDatosVerServicios {
	return startModelPedirDatosVerServicios(fields, title, funcion_general, funcion_general_tipo, funcion_unica)
}
